...
public class MaxConsecutiveOnes485Tests
{
    ...
    public void FindMaxConsecutiveOnes_SlidingWindows_ShouldReturnExpected_SlidingWindows(int[] nums, int expected)
    {
        var result = MaxConsecutiveOnes485.FindMaxConsecutiveOnes_SlidingWindows(nums);
